...
| [`design-control-validation/`](design-control-validation/) | Retained post-critique regression result with raw case counts, test identifiers, runtime identity, explicit external exclusions, and the binary64 boundary observation | **Executable maintenance evaluation.** Twelve named control/diagnostic cases pass in the retained result; this is neither a safety score nor release authorization. | `scripts/evaluate_design_controls.py` |
